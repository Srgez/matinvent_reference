...
# Job configuration
# ──────────────────────────────────────────────────────────────
JOB_NAME="${JOB_NAME:-matinvent-lite-ehull}"
GPU_NUM="${GPU_NUM:-1}"
...
# Experiment identity
# ──────────────────────────────────────────────────────────────
EXP_NAME="${EXP_NAME:-grpo_lite_ehull_v1_1}"
RESULTS_DIR="${RESULTS_DIR:-exp_res_1}"
...
python -u main.py \
  ...
  sample_cfg.filter.reference_path=${REFERENCE_DATASET_PATH} \
  \
